...
?>
<div class="container">
    <form method="post" action="script_disc_modif.php" id="formulaire_modif" enctype="multipart/form-data">
        <fieldset>
            ...
            <img src="jaquettes/<?= $disc->disc_picture ?>" alt="pochette" class="img-fluid"><br><br>
